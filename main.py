...
from PyQt5.QtWidgets import QDialog, QLabel, QComboBox, QVBoxLayout, QHBoxLayout, QPushButton, QCheckBox
import gettext
...
class LanguageSelectionDialog(QDialog):
    def __init__(self, parent, language):
        ...
        # Pack the widgets into a vertical layout
...
class SelectGame(Gtk.Window):
    def __init__(self):
        ...
        if self.pref.remember_language == 1:
            ...
            lang_dialog = LanguageSelectionDialog(None, self.pref.language)
            response = lang_dialog.exec_()
            ...
            if response == QDialog.Accepted:
                ...
                app.quit()  # Quit the application if the dialog is canceled
                exit()
